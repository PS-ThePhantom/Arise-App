  ...
  return (
    ...
    <div className="Faqs-container">
      ...
      <div className="Faqs">
        ...
        <div className="Faq">
          <button className="Faq-header" onClick={faq1Open = !faq1Open}>
        ...
        <div className="Faq">
          <a className="Faq-header" onClick={faq2Open = !faq2Open}>
        ...
        <div className="Faq">
          <a className="Faq-header" onClick={faq3Open = !faq3Open}>
        ...
        <div className="Faq">
          <a className="Faq-header" onClick={faq4Open = !faq4Open}>
        ...
        <div className="Faq">
          <a className="Faq-header" onClick={faq5Open = !faq5Open}>
